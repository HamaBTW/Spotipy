...
if __name__ == "__main__":
    ...
    if not os.path.exists(file_path):
        f = open(file_path, "wb")
        dump({"client_id":"", "client_secret":""}, f)
        f.close()

    data = load_data(file_path)
    #print(data['client_id'], data['client_secret'])

    app = SpotifyApp(
        #client_id=data['client_id'],
        #client_secret=data['client_secret'],
        
        client_id="81b913f2537b41c59ed79a0e7319d24d",
        client_secret="a4d4c9f482bb4ef08d8e4f6dfa491893",
    ...
    #pyinstaller web_app5.py --add-data "templates;templates" --add-data "static;static" --onefile --name "Spotipy Web Connector" --icon=icon.ico
