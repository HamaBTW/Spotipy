...
if __name__ == "__main__":
    ...
    if os.path.exists(file_path):
        ...
        app = SpotifyApp(
            client_id= web_data['client_id'], #"870fbcd0954446088a4de2553863b40e",
            client_secret= web_data['client_secret'], #"5e706285917245d4a45c77fd11f58eca",
    ...
    #pyinstaller web_app6.py --add-data "templates;templates" --add-data "static;static" --onefile --name "Spotipy Web Connector" --icon=icon.ico
